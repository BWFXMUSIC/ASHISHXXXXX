...
async def gen_qthumb(videoid, user_id):
    ...
    try:
        ...
        font = ImageFont.truetype("helper/rj/font.otf", 55)
        font2 = ImageFont.truetype("helper/rj/font.otf", 35)
        draw.text((670, 555), f"Title: {title[:50]} ...", (255, 255, 255), font=font)
        draw.text((670, 615), f"Duration: {duration}", (255, 255, 255), font=font)
        draw.text((270, 675), f"Views: {views}", (255, 255, 255), font=font)
